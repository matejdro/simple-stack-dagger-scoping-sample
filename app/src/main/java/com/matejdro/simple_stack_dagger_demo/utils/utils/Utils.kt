package com.matejdro.simple_stack_dagger_demo.utils.utils
...
inline fun <reified T> Fragment.canFind(serviceTag: String = T::class.java.name) =
    Navigator.canFindService(requireContext(), serviceTag)
...
inline fun <reified T> ServiceBinder.get(serviceTag: String = T::class.java.name) =
    getService<T>(serviceTag)
